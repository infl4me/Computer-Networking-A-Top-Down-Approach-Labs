...
another host, open a browser and provide the corresponding URL. For example: http://128.238.251.26:6789/HelloWorld.html. `HelloWorld.html` is the name of the file you placed in the server directory. Note also the use of the port
